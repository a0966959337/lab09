...
LBLEService ledService("05051160-E8F2-537E-4F6C-D104768A1214");
LBLECharacteristicInt switchCharacteristic("05051160-E8F2-537E-4F6C-D104768A1214", LBLE_READ | LBLE_WRITE);
...
void setup() {
  ...
  advertisement.configAsConnectableDevice("李承諺");
